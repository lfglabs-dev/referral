...
if VARS["name"] == "mainnet":
    ...
    ADMIN = os.getenv("MAINNET_ADMIN_ADDR")
    NAMING_CONTRACT = os.getenv("MAINNET_NAMING_CONTRACT")
    MIN_CLAIM_AMOUNT = os.getenv("MAINNET_MIN_CLAIM_AMOUNT")
    DEFAULT_SHARE = os.getenv("MAINNET_DEFAULT_SHARE")
elif VARS["name"] == "testnet2":
    VARS["rpc_url"] = os.getenv("TESTNET2_RPC_URL")
    VARS["chain_id"] = StarknetChainId.TESTNET2
    ADMIN = os.getenv("TESTNET2_ADMIN_ADDR")
    NAMING_CONTRACT = os.getenv("TESTNET2_NAMING_CONTRACT")
    MIN_CLAIM_AMOUNT = os.getenv("TESTNET2_MIN_CLAIM_AMOUNT")
    DEFAULT_SHARE = os.getenv("TESTNET2_DEFAULT_SHARE")
elif VARS["name"] != "devnet":
    VARS["rpc_url"] = os.getenv("TESTNET_RPC_URL")
    VARS["chain_id"] = StarknetChainId.TESTNET
    ADMIN = os.getenv("DEVNET_ADMIN_ADDR")
    NAMING_CONTRACT = os.getenv("DEVNET_NAMING_CONTRACT")
    MIN_CLAIM_AMOUNT = os.getenv("DEVNETMIN_CLAIM_AMOUNT")
    DEFAULT_SHARE = os.getenv("DEVNET_DEFAULT_SHARE")
else:
    ADMIN = os.getenv("TESTNET_ADMIN_ADDR")
    NAMING_CONTRACT = os.getenv("TESTNET_NAMING_CONTRACT")
    MIN_CLAIM_AMOUNT = os.getenv("TESTNET_MIN_CLAIM_AMOUNT")
    DEFAULT_SHARE = os.getenv("TESTNET_DEFAULT_SHARE")
